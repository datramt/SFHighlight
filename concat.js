  ...
  (err, stdout) => {
    ...
    exec(
      ...
      (err) => {
        ...
        console.log(
          "Probing duration of video stream & audio stream to determine how many seconds the ending sequence is"
        );
        console.log(
          "Adding silence to end of audio stream so that both streams match in duration"
        );
        exec(
